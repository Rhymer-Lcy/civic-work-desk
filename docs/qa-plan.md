...
| `npm run test:uos`         | 114 assertions against real BusyBox / `/proc` / signals on a POSIX host             |
| `npm run test:uos:archive` | 51 checks over the bytes of **both** delivered tars                                 |
