...
out ""
out "PRIVACY NOTE: section 2 contains the output of \`id\` and the value of \$HOME, which include"
out "your account name. They are here because a non-root install depends on UID/GID and on the"
out "home path being writable. If you would rather not share the account name, replace it with"
out "<user> before sending this file — none of the deployment decisions need it."
